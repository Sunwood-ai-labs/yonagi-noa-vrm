...
**[衝突補正 BEFORE / AFTER 比較ページ](https://sunwood-ai-labs.github.io/yonagi-noa-vrm/compare.html)**では、RTX 4090で生成したARDY生モーションと補正版を、同じモデル・時刻・カメラで左右に同期表示できます。6モーション切替、同時再生、一時停止、任意フレームのスクラブ、両ビューのカメラ同期に対応し、スマホ幅でも左右2列を維持します。

![ARDY生モーションと衝突補正版の同期比較](artifacts/compare-page/desktop-viewport-v2.png)

[スマホ横並び表示](artifacts/compare-page/mobile-side-by-side-v4.png)
